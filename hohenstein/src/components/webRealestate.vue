...
<div>
  <div v-if="this.isMobile">
   <nav>
    ...
    <p class="category">
      <span style="font-family: 'Helvetica'"> / </span>Real Estate
    </p>  
    <p class="slog3an">
     INVEST IN <br />
       REAL ESTEATE
  ...
  <li style="padding-bottom:10px;">Soziale Aspekte</li>
  ...
  <div v-if="!this.isMobile" class="mobileContentDiv">
      ...
      <div class="mobileContent">
        ...
        <p class="item1">
          ...
          &#10003; Immobilienverkauf
          <br/>
          &#10003; Immobilenvermittlung
          <br/>
          &#10003; Immobilienfinanzierung
          <br/>
          &#10003; Soziale Aspekte
         </p>
                 <p><span style="font-size: 27px;">W</span>ir vermitteln Ihnen Immobilien mit Potenzial. Von dem Erwerb eines Gewerbegrunds bis hin zur privaten Investitionsanlage finden wir für Sie attraktive Immobilien. Sie möchten Ihr Immobilienprojekt finanzieren lassen? Dann erfahren sie <b><a href="www.google.at">hier</a></b>, wie Sie in dem Aspekt bei uns beraten lassen können.  </p>
        <p class="item3">
